...
public class AlimentoDAO {
     ...
     * @return ID do alimento criado ou null se falhar
     */
    ...
    public List<Alimento> buscarPorNomeParcial(String nomeParcial) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            while (rs.next()) {
                alimentos.add(montarAlimento(rs));
            }
     ...
     * ATENÇÃO: Pode falhar se o alimento estiver vinculado a refeições
     */

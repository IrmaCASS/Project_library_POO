...
public class RefeicaoDAO {
    ...
    public void salvarRefeicao(String tipo, double kcal, int usuarioId) {
        // Assume-se que a coluna data_refeicao existe na tabela
        String sql = "INSERT INTO refeicao (tipo_refeicao, calorias, usuario_id, data_refeicao) VALUES (?, ?, ?, CURRENT_DATE)";
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
